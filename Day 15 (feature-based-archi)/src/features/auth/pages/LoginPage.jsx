...
import { ArrowRightCircle, Lock, Mail } from "lucide-react";
...
const LoginPage = () => {
    ...
    let{ handleLoginFormSubmit , register , handleSubmit , errors , navigate ,  } = useAuth()
        ...
        <div className="min-h-screen bg-gray-100 flex items-center justify-center px-4">
            <div className="w-full max-w-md text-center">
                ...
                >
                    ...
                    {/* Button */}
                    <Button text={"Authenticate Securely  " }  />
