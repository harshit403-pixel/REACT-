...
let onSubmit = (data) => {
  ...
  if (
    storedUser &&
    (data.email !== storedUser.email || data.password !== storedUser.password)
  ) {
  ...
  return (
    <div className='h-full w-full flex items-center justify-center '>
     ...
     <div className='flex flex-col gap-2 justify-center items-center'>
        ...
        <h1 className='text-xl text-white font-semibold font-second'>Welcome Back</h1>
        <p className='text-white/60 text-[15px] font-second'>Sign in to your account to continue</p>
     ...
     className='text-[#008c75] hover:underline cursor-pointer'>Sign up</span></p>
