...
const Posts = ({user}) => {
  return (
    <div>
            <div className='h-[320px] w-[300px] cursor-pointer group transition duration-300 hover:border-[#008c75] p-7 flex flex-col gap-10 border border-white/20 rounded-xl bg-[#0a0e11] '>
...
<div className='flex flex-col gap-2'>
      ...
      <div className='flex flex-wrap gap-1'>
        ...
        <h1 className='text-xl font-bold transition duration-300 group-hover:text-[#008c75] text-white'>  {user.title}</h1>
</div>
     
      
      <p className='text-sm text-white/50'> {user.excerpt}</p>
      ...
      <div className='text-white/70 flex gap-1 items-center '>
        ...
        <h1 className='text-white/70 text-[12px] '> {user.authorName}</h1>
      </div>
      <div className='text-white/70 flex gap-1 items-center '>
        ...
        <h1 className='text-white/70 text-[12px] '> {new Date(user.createdAt).toLocaleDateString()}</h1>
      </div>
